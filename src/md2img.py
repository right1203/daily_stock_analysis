# -*- coding: utf-8 -*-
"""
Markdown-to-image utility module.

Converts Markdown to PNG for notification channels that do not support Markdown.
Supports wkhtmltoimage (imgkit) and markdown-to-file (m2f), with m2f providing
better emoji support (Issue #455).
