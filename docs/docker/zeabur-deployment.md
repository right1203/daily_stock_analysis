...
本指南详细介绍如何在 Zeabur 上배포 A股自选股智能分析系统，包括 WebUI 和 Discord 机器人功能。

## 目录

- [1. 배포前准备](#1-배포前准备)
- [2. 在 Zeabur 上배포](#2-在-zeabur-上배포)
- [3. 配置启动命令](#3-配置启动命令)
- [4. Discord 机器人배포](#4-discord-机器人배포)
- [5. 环境变量配置](#5-环境变量配置)
- [6. 挂载配置](#6-挂载配置)
- [7. 健康检查](#7-健康检查)
...
如有문제，欢迎联系项目维护者或在 GitHub Issues 中提问。
