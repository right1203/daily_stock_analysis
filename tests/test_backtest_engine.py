...
class BacktestEngineTestCase(unittest.TestCase):
    ...
    def test_korean_negated_sell_not_bearish(self):
        # Korean negation prefix before sell should NOT be direction=down
        self.assertNotEqual(BacktestEngine.infer_direction_expected("하지 않 매도"), "down")
